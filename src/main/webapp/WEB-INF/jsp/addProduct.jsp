				...
				<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
					...
					<div class="row tm-edit-product-row">
						<div class="col-xl-6 col-lg-6 col-md-12">
							<form action="submitForm" modelAttribute="Product" class="tm-edit-product-form">
								...
								<div class="form-group mb-3">
									<label for="name">Product Seller
									</label> <input id="seller" name="seller" type="text"
										class="form-control validate" required />
								</div>
								<!-- <div class="form-group mb-3">
						...
						<div class="col-12">
							<button type="submit"
								class="btn btn-primary btn-block text-uppercase" onClick="location.href='/products/addingProduct'">Add
								Product Now</button>
						</div>
						</form>
					</div>
